...
<main id="home">
    ...
    <section class="nature">
        <div class="cave-scene" id="cave-scene" aria-label="Carat Street forest jewellery reveal"><img class="cave-reveal" src="assets/open-cave.png" alt="Enchanted green forest within a rocky cave"><div class="cave-wordmark" aria-hidden="true"><span>Carat</span><span>Street</span></div><img class="cave-hand" src="assets/only-hand.png" alt="Moss-covered hand presenting a gemstone ring"><img class="tree-left" src="assets/web/cave-left-tree.webp" alt=""><img class="tree-right" src="assets/web/cave-right-tree.webp" alt=""><img class="cave-closed" src="assets/web/cave-closed-layer.webp" alt=""><button class="cave-toggle" type="button" aria-expanded="false" aria-controls="cave-scene"><span>Tap To Reveal</span></button></div>
